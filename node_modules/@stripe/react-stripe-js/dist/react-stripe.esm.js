import { useRef, useEffect, createContext, useMemo, useState, createElement, useContext, useLayoutEffect } from 'react';
...
const createElementComponent = (type, isServer) => {
    ...
    const ClientElement = ({ id, className, options = {}, onBlur = noop, onFocus = noop, onReady = noop, onChange = noop, onClick = noop, }) => {
        ...
        return createElement("div", { id: id, className: className, ref: domNode });
    };
