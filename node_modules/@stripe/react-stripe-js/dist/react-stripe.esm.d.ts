...
type CardElementComponent = React.FC<CardElementProps>;
...
type CardNumberElementComponent = React.FC<CardNumberElementProps>;
...
type CardExpiryElementComponent = React.FC<CardExpiryElementProps>;
...
type CardCvcElementComponent = React.FC<CardCvcElementProps>;
...
type IbanElementComponent = React.FC<IbanElementProps>;
...
type IdealBankElementComponent = React.FC<IdealBankElementProps>;
...
type PaymentRequestButtonElementComponent = React.FC<PaymentRequestButtonElementProps>;
 ...
 * @docs https://stripe.com/docs/stripe-js/react#elements-consumer
 */
declare const ElementsConsumer: React.FC<ElementsConsumerProps>;
/**
...
export { useElements, useStripe, Elements, ElementsConsumer, CardElement, CardNumberElement, CardExpiryElement, CardCvcElement, IbanElement, IdealBankElement, PaymentRequestButtonElement };
